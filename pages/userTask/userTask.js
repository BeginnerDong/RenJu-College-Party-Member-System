      ...
      if(res.info.data.length>0){
        ...
        /*for (var i = 0; i < self.data.mainData.length; i++) {
          if(self.data.mainData[i].message.length>0){
            self.data.mainData[i].message[0].passage1 = parseInt(self.data.mainData[i].message[0].passage1)/1000,
            self.data.mainData[i].message[0].create_time = parseInt(self.data.mainData[i].message[0].create_time)
          }
        }*/
      }else{
